...
@Component({
    selector: 'app-vertical-secretary',
    templateUrl: './verticalSecretary.component.html',
    styleUrls: ['./verticalSecretary.component.scss'],
    standalone: false
})
export class VerticalSecretaryComponent implements OnInit {
